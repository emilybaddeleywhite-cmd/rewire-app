...
function SocialNudgeModal({ onClose }) {
  const SOCIALS = [
    { label: 'Trustpilot', href: 'https://uk.trustpilot.com/review/rewiremode.com', color: '#00b67a', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0L14.9 8.9H24L16.5 14.3L19.4 23.2L12 17.8L4.6 23.2L7.5 14.3L0 8.9H9.1Z"/></svg>, cta: 'Leave a review' },
    { label: 'Instagram', href: 'https://www.instagram.com/rewiremodeai/', color: '#E1306C', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>, cta: 'Follow us' },
    { label: 'Facebook', href: 'https://www.facebook.com/profile.php?id=61588980175128', color: '#1877F2', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>, cta: 'Follow us' },
    { label: 'TikTok', href: 'https://www.tiktok.com/@rewiremodeai', color: '#ffffff', icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.2 8.2 0 004.79 1.53V6.78a4.85 4.85 0 01-1.02-.09z"/></svg>, cta: 'Follow us' },
  ]
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(10,12,22,0.85)', backdropFilter: 'blur(8px)', zIndex: 9000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }} onClick={onClose}>
      <div style={{ background: C.bg, border: `1px solid ${C.border}`, borderRadius: '20px', padding: '32px 28px', maxWidth: '380px', width: '100%', boxShadow: '0 24px 80px rgba(0,0,0,0.6)', animation: 'fadeUp 0.35s ease both' }} onClick={e => e.stopPropagation()}>
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          <div style={{ fontSize: '36px', marginBottom: '12px' }}>✨</div>
          <h2 style={{ fontSize: '20px', fontWeight: '800', color: C.textH, marginBottom: '8px', fontFamily: "'Sora',sans-serif" }}>Enjoying RewireMode?</h2>
          <p style={{ fontSize: '13px', color: C.textBody, lineHeight: 1.6 }}>Follow us for tips, updates and behind-the-scenes content — or leave a review to help others find us.</p>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '18px' }}>
          {SOCIALS.map(s => (
            <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '13px 16px', borderRadius: '12px', background: s.color + '12', border: `1px solid ${s.color}30`, textDecoration: 'none', transition: 'background 0.2s' }} onMouseEnter={e=>e.currentTarget.style.background=s.color+'22'} onMouseLeave={e=>e.currentTarget.style.background=s.color+'12'}>
              <span style={{ color: s.color }}>{s.icon}</span>
              <span style={{ flex: 1, fontSize: '14px', fontWeight: '700', color: C.textH }}>{s.label}</span>
              <span style={{ fontSize: '12px', color: s.color, fontWeight: '600' }}>{s.cta} →</span>
            </a>
          ))}
        </div>
        <button onClick={onClose} style={{ width: '100%', padding: '12px', borderRadius: '12px', border: `1px solid ${C.border}`, background: 'transparent', color: C.textMuted, fontSize: '13px', cursor: 'pointer' }}>Maybe later</button>
      </div>
    </div>
  )
}
  ...
  async function startGenerate() {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        const genCount = parseInt(localStorage.getItem('rm_gen_count') || '0') + 1
        localStorage.setItem('rm_gen_count', String(genCount))
        if (genCount === 1 || genCount % 3 === 0) setTimeout(() => setShowSocialNudge(true), 2400)
      }, 400)
    } catch (err) {
      clearInterval(progressRef.current); clearInterval(loadMsgRef.current)
        ...
        <footer style={{ borderTop: `1px solid ${C.border}`, padding: '36px 0' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 36px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              <a href="https://uk.trustpilot.com/review/rewiremode.com" target="_blank" rel="noopener noreferrer" title="Review us on Trustpilot" style={{ color: C.textMuted, textDecoration: 'none', fontSize: '12px', display: 'flex', alignItems: 'center', gap: '5px', transition: 'color 0.2s' }} onMouseEnter={e=>e.currentTarget.style.color='#00b67a'} onMouseLeave={e=>e.currentTarget.style.color=C.textMuted}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0L14.9 8.9H24L16.5 14.3L19.4 23.2L12 17.8L4.6 23.2L7.5 14.3L0 8.9H9.1Z"/></svg>
                Trustpilot
              </a>
              <a href="https://www.instagram.com/rewiremodeai/" target="_blank" rel="noopener noreferrer" title="Instagram" style={{ color: C.textMuted, transition: 'color 0.2s' }} onMouseEnter={e=>e.currentTarget.style.color='#E1306C'} onMouseLeave={e=>e.currentTarget.style.color=C.textMuted}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
              </a>
              <a href="https://www.facebook.com/profile.php?id=61588980175128" target="_blank" rel="noopener noreferrer" title="Facebook" style={{ color: C.textMuted, transition: 'color 0.2s' }} onMouseEnter={e=>e.currentTarget.style.color='#1877F2'} onMouseLeave={e=>e.currentTarget.style.color=C.textMuted}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.tiktok.com/@rewiremodeai" target="_blank" rel="noopener noreferrer" title="TikTok" style={{ color: C.textMuted, transition: 'color 0.2s' }} onMouseEnter={e=>e.currentTarget.style.color='#ffffff'} onMouseLeave={e=>e.currentTarget.style.color=C.textMuted}>
            ...
            <div style={{ fontSize: '12px', color: C.textMuted, width: '100%', textAlign: 'center', borderTop: `1px solid ${C.border}`, paddingTop: '16px', marginTop: '4px' }}>Built by a qualified hypnotherapist · © 2025 RewireMode</div>
          </div>
        </footer>
      </div>
