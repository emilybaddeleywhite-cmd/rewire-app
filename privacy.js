      ...
      <div style={{ minHeight: '100vh', background: BASE.bg, color: BASE.text, fontFamily: "'Inter','Segoe UI',system-ui,sans-serif" }}>
        <style>{`
          *{box-sizing:border-box;margin:0;padding:0}
          ...
          th{text-align:left;padding:10px 12px;color:#00d4ff;font-weight:600;border-bottom:1px solid rgba(255,255,255,0.08)}
        ...
        <nav style={{ position: 'relative', zIndex: 10, borderBottom: '1px solid rgba(0,212,255,0.08)', backdropFilter: 'blur(10px)', background: 'rgba(5,10,20,0.85)' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', padding: '0 24px 10px' }}>
            <a href="/"><img src={LOGO} alt="RewireMode" style={{ height: '80px', objectFit: 'contain', mixBlendMode: 'lighten' }} onError={e => { e.target.style.display='none' }} /></a>
          </div>
        </nav>
        ...
        <div style={{ maxWidth: '760px', margin: '0 auto', padding: '48px 20px 80px', position: 'relative', zIndex: 1 }}>
          ...
          <h2>1. Who We Are</h2>
          <p>RewireMode is operated by Emily Baddeley White, trading as RewireMode, based in the United Kingdom. We are the data controller for the personal data we collect through this service.</p>
