    ...
    questions: [
      {
        ...
        a: `Yes. The effectiveness of hypnosis comes from the structure and language of the script, not who writes it. RewireMode uses the same proven techniques used in clinical practice: embedded commands, presuppositions, somatic anchoring, future pacing, and identity-level suggestion. Dozens of peer-reviewed studies have shown hypnotherapy helps with anxiety, pain relief, sleep disorders, and behavioural change (Montgomery et al., 2013; Jensen et al., 2015). What matters is that the framework is sound, and that you are consistent.`,
      },
      {
        q: 'How does hypnosis work in the brain?',
        a: `During hypnosis, your brain shifts into theta state, a brainwave frequency of 4 to 8 Hz associated with deep sleep, vivid imagination, and subconscious receptivity. In this state, the amygdala quiets, the critical faculty softens, and the subconscious becomes open to new suggestion. A systematic review published in PMC (Facco et al., 2022) found that hypnosis produces measurable changes in brain connectivity, particularly in areas governing emotional regulation, self-awareness, and behaviour. Research published in Psychology Today (Lancaster et al., 2024) confirmed that theta wave activity is positively associated with hypnosis and increased response to suggestion. These are not temporary effects. They are structural changes.`,
      },
      {
        q: 'What is neuroplasticity and why does it matter?',
        a: `Neuroplasticity is your brain's ability to reorganise itself by forming new neural connections throughout life. It means that deeply ingrained thought patterns, emotional responses, and limiting beliefs are not permanent. They are patterns. And patterns can be changed. fMRI research (Jiang et al., 2017) showed that during hypnosis, the prefrontal cortex increases connectivity with the insula while simultaneously decreasing connectivity with the default mode network — the region responsible for self-critical and habitual thought loops. Hypnosis creates the optimal conditions for neuroplastic change. Repetition strengthens those pathways over time.`,
      },
      {
        q: 'What is a subliminal session?',
        a: `A subliminal session layers identity-level suggestions quietly under music. While you listen passively, your subconscious receives repeated positive suggestion below the threshold of conscious awareness. Research into subliminal processing shows that the brain continues to process stimuli it does not consciously register. Repeated exposure to identity-level statements gradually strengthens the neural pathways associated with those beliefs, shifting them from something you are trying to believe into something you simply are.`,
      },
      {
