...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ── SAVE SESSION FIRST — before touching credits ──
    ...
    if (sessionError) {
      ...
      return res.status(500).json({ error: 'Could not save session. Your audio played successfully — please try saving again.' })
    }
